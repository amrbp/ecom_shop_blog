...
from web_design import views as web_view
from users import views as user_views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', web_view.home_page, name="home"),
    path('about/', web_view.about_page, name="about"),
    path('contact/', web_view.contact_page, name="contact"),
